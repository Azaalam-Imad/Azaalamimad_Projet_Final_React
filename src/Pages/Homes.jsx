            ...
            <section className="flex flex-wrap justify-center gap-6 px-4 py-10">
                <div className="flex flex-col gap-6 w-full md:w-[45%] lg:w-[30%]">
                    ...
                    <div className="h-60 overflow-hidden relative">
                        ...
                        <button className="absolute left-1/2 -translate-x-1/2 bottom-4 bg-white px-6 py-2 text-[18px] hover:bg-orange-700 hover:text-white">SUNGLASSES</button>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-6 w-full md:w-[45%] lg:w-[30%]">
                    <div className="h-60 overflow-hidden relative">
                        ...
                        <button className="absolute left-1/2 -translate-x-1/2 bottom-4 bg-white px-6 py-2 text-[18px] hover:bg-orange-700 hover:text-white">WATCHES</button>
                    </div>
                    <div className="h-80 overflow-hidden relative">
                        <img src={Images.cards3} alt="" className="h-full w-full object-cover hover:scale-110 duration-300" />
                        <button className="absolute left-1/2 -translate-x-1/2 bottom-4 bg-white px-6 py-2 text-[18px] hover:bg-orange-700 hover:text-white">FOOTERWEAR</button>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-6 w-full md:w-[45%] lg:w-[30%]">
                    <div className="h-80 overflow-hidden relative">
                        ...
                        <button className="absolute left-1/2 -translate-x-1/2 bottom-4 bg-white px-6 py-2 text-[18px] hover:bg-orange-700 hover:text-white">BAGS</button>
                    </div>
                    <div className="h-60 overflow-hidden relative">
                        <img src={Images.cards6} alt="" className="h-full w-full object-cover hover:scale-110 duration-300" />
                        <button className="absolute left-1/2 -translate-x-1/2 bottom-4 bg-white px-6 py-2 text-[18px] hover:bg-orange-700 hover:text-white">ACCESSORIES</button>
                    </div>
                </div>
            </section>
